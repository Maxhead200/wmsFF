...
- `apps/api` - NestJS API, Prisma-схема, авторизация/RBAC, клиентские заявки, биллинг услуг, импорты XLSX, логистические тарифы, stock ledger, печать TSC и API для ТСД.
