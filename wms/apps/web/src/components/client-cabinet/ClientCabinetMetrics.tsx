...
import type { BillingInvoiceSummary, ClientRequestSummary, StockBalance } from '../../lib/api';
...
export function ClientCabinetMetrics({ stock, requests, invoices }: ClientCabinetMetricsProps) {
