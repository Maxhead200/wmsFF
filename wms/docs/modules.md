...
- Web-интерфейс показывает панель биллинга: создание услуг, ручные начисления, счета, оплаты и статусы утверждения.
...
- Биллинг: автоматические начисления за хранение по литражу, акты и печатные формы финансовых документов.
