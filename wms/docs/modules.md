...
- Web-интерфейс показывает панель биллинга: создание услуг, ручные начисления и статусы утверждения.
...
- Биллинг: автоматические начисления за хранение по литражу, счета, акты, оплаты.
