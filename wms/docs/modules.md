...
- Web-интерфейс показывает панель печати: фиксированные preview короб/SKU/паллета и редактор сохраненных TSPL-шаблонов с переменными.

## Следующие этапы

- Расширение клиентского кабинета: история услуг, файлы заявок и уведомления.
...
- Печать: версии шаблонов, отправка на конкретный принтер и очередь заданий печати.
