...
- Web-интерфейс показывает панель печати: фиксированные preview короб/SKU/паллета, редактор сохраненных TSPL-шаблонов, справочник принтеров и очередь заданий.
...
- Печать: версии шаблонов, аудит перепечаток и права на отдельные группы принтеров.
