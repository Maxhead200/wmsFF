...
- Web-интерфейс показывает панель печати: фиксированные preview короб/SKU/паллета, редактор сохраненных TSPL-шаблонов с историей версий, справочник принтеров, очередь заданий и повторную постановку задания в печать с audit-связью.
...
- Печать: права на отдельные группы принтеров.
